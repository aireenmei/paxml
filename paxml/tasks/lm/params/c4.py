...
@experiment_registry.register
class C4Spmd128BAdam256Replicas_save_nothing_batch1024(C4SpmdAdam):
...
@experiment_registry.register
class C4Spmd128BAdam256Replicas_mlperf_batch256(C4SpmdAdam):
  r"""GPT-3 config with 128B params. Model Parameters: 
  Global batch size = 1 * 64 * 4 * 1 = 256"""
  NUM_LAYERS = 71
  MODEL_DIMS = 12288
  HIDDEN_DIMS = MODEL_DIMS * 4
  NUM_HEADS = 96
